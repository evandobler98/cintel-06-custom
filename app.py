...
h2, h1 {
    color: #006064;           /* Dark teal for headers */
    text-shadow: 1px 1px 3px #b2ebf2; /* Subtle shadow for depth */
}
.sidebar {
...
.card-header {
    font-weight: bold;
    background-color: #0288d1; /* Light blue header background */
...
# Add the custom styles using `ui.tags.style`
ui.tags.style(custom_styles)
